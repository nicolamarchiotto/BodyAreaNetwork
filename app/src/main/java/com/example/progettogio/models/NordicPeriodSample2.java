...
public class NordicPeriodSample2 {
    ...
    public NordicPeriodSample2(String thingyName, String deviceAddress, SubSectionCallback subsessionCallback) {
        nordicAddress = deviceAddress;
        subsession = 0;
        nordicName = thingyName;
        callback = subsessionCallback;

        quaternionArray = new MutableDictionary[500];
        accelerometerArray = new MutableDictionary[500];
        gyroscopeArray = new MutableDictionary[500];
        compassArray = new MutableDictionary[500];
        eulerAngleArray = new MutableDictionary[500];
        headingArray = new MutableDictionary[500];
        gravityVectorArray = new MutableDictionary[500];
...
//                +" Z:"+dictionary.getDouble("Z")+" Timestamp"+dictionary.getLong("TimeStamp"));
    ...
    public void doSubsection(){
        if(!creatingSupportArray){
            ...
            callback.doNordicSubsection2(nordicAddress,subsession);
            subsession+=1;
